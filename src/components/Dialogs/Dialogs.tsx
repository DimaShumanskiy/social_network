...
const Dialogs = (props: PropsDialogsType) => {
    ...
    let dialogsElements = state.dialogs.map(d => <DialogItem name={d.name} id={d.id}/>);  //d- dialog
    let messageElements = state.messages.map(m => <Message message={m.message}/>) // m - message
